        ...
        <div class="app" id="app" class="app header-fixed sidebar-fixed">
            ...
            <article class="content forms-page">
                ...
                <div class="subtitle-block">
                    <h3 class="subtitle"> Promotion </h3>
                </div>
                    ...
                    <div class="row sameheight-container">
                        <div class="col-md-12">
                            <div class="card card-block sameheight-item">
                                <form role="form" id="sendpromote" action="sendpromote.php" method="GET">
                                    <div class="form-group">
                                        <br>
                                        <div>
                                            <div style="font-weight:bold;"> Promotion </div>
                                            </label>
                                            <br>
                                            ...
                                            <div class="form-group">
                                                <br>
                                                <span style="margin-right: 2%">Reason for Promotion</span>
