            ...
            ?>
                ...
                <article class="content forms-page">
                    ...
                    <div class="title-block">
                        <h3 class="title">Resignment</h3>
                        <p class="title-description">Resignment forms for Staff</p>
                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-block sameheight-item">
                                    <div class="form-group">
                                        <form role="form" id="contact" action="sendresignation.php" method="get">
                                            ...
                                            <div class="form-inline">
                                                <span>Reason to resign &nbsp;</span>
                                                <input type="textarea" rows="4" cols="50" name="Reason" class="form-control underlined">
                                            </div>
                                            <br>
                ...
                <script>
                    ...
                    function displayResponseDepartment(response) {
                        ...
                        var i;
                        var out = '<optsion value="" disabled selected>Choose your option</option>';
