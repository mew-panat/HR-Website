        ...
        <div class="app" id="app" class="app header-fixed sidebar-fixed">
            ...
            <!-- The Modal -->
                    ...
                    <div class="title-block">
                        <h3 class="title">Absence</h3>
                        <p class="title-description">Absence forms for Staff</p>
                    </div>
                        ...
                        <div class="row sameheight-container">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-block sameheight-item">
                                    <form role="form" id="newctivities" action="sendabsence.php" method="GET">
                                        <div class="form-group">
                                            ...
                                            <div class="form-inline">
                                                ...
                                                <span style="margin-left : 1%"> Position &nbsp;&nbsp;</span>
                                                <select id="pos01" class="form-control" name="cur_position">
                                                <option value="Choose your option" disabled selected>Choose your option</option> </select> 
                                            </div>
                                            <br>
                                            <div class="form-group">                                                
                                                <span>Type of absence &nbsp; &nbsp;</span> <br><br>       
                                                    <div class="row" style="margin-left: 2%">                                         
                                                        <input type="radio" name="absenceType" value="Sick"> &nbsp; 
                                                        <span>Sick</span> &nbsp; &nbsp;                                              
                                                        <input type="radio" name="absenceType" value="Vacation">&nbsp;
                                                        <span>Vacation</span>&nbsp; &nbsp;
                                                        <input type="radio" name="absenceType" value="Bereavement"> &nbsp;
                                                        <span>Bereavement</span> &nbsp;&nbsp;
                                                        <input type="radio" name="absenceType" value="Military"> &nbsp;
                                                        <span>Military</span> &nbsp;&nbsp;                                                
                                                        <input type="radio" name="absenceType" value="Marternity"> &nbsp;                                               
                                                        <span>Marternity/Paternity</span> &nbsp;&nbsp; 
                                                        <input type="radio" name="absenceType" value="Personal"> &nbsp;                                               
                                                        <span>Other</span> &nbsp;&nbsp;     
                                                    </div>                                     
                                            </div>
                                            <br>
                                            <div class="form-inline">
                                                ...
                                                <input type="date" name="getdate" class="form-control underlined">  
                                            </div>
                                            <br>
